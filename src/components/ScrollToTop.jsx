...
export default function ScrollToTop() {
  ...
  return (
    <>
      ...
      {/* 📜 বাম দিকে থাকা স্ক্রল-টু-টপ বাটন উইথ সার্কুলার প্রোগ্রেস */}
      {isVisible && (
        <div className="fixed bottom-6 left-6 z-50 transition-opacity duration-300">
          <button
            onClick={scrollToTop}
            title="Back to top"
            className="relative w-12 h-12 rounded-full bg-gradient-to-br from-cyan to-cyan2 border border-white/10 cursor-pointer flex items-center justify-center text-black text-[1.3rem] font-bold shadow-[0_4px_20px_rgba(0,212,255,0.2)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_8px_25px_rgba(0,212,255,0.45)] active:scale-90 group"
          >
            ...
            >
              ...
              <circle
                ...
                fill="transparent"
              />
              {/* Progress Ring (Dynamic fill according to scroll) */}
              <circle
                cx="24"
                cy="24"
                r={radius}
                className="stroke-black transition-all duration-150 ease-out"
                strokeWidth="3"
