...
export default function ScrollToTop() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-center">
      {/* 🟢 Original WhatsApp Image/Icon Button */}
      <a
        href="https://wa.me/8801511994008" // 👈 এখানে কান্ট্রি কোডসহ আপনার নাম্বারটি দিন
        target="_blank"
      ...
      >
        {/* Official WhatsApp SVG Logo (নিখুঁত সাইজের জন্য p-2.5 ব্যবহার করা হয়েছে) */}
        <svg
          className="w-full h-full p-2.5 fill-current transition-transform duration-300 group-hover:scale-110"
          viewBox="0 0 24 24"
