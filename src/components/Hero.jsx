...
export default function Hero() {
  ...
  const titles = [
    ...
    {
      text: "Cyber Security Researcher",
      color: "text-red-400",
    },
  ];
  ...
  // ==========================================
  // DYNAMIC RESUME HANDLER
  // ==========================================
  const handleViewResume = (e) => {
    /*
      IMPORTANT:

      Resume is no longer hard-coded like:
      ...
      The API gets the latest PDF from
      MongoDB + Cloudinary dynamically.
    */
    ...
    /*
      ...
      So browser will naturally open:
    ...
    */
    ...
    // Loading animation automatically ends
    // after a short time.
    setTimeout(() => {
  ...
  const nodes = [
...

    {
      ...
      icon: (
        ...
        >
          <path
            d="M3.89 15.75L9.31 4.91c.2-.39.77-.39.97 0l1.8 3.59-8.19 7.25z"
            fill="#FFC400"
          />

          <path
            d="M13.92 10.38l1.9-3.78c.2-.39.77-.39.97 0l3.32 6.58-6.19-2.8z"
            fill="#FF9100"
          />

          <path
            d="M2.5 18.25l1.62-1.43 8.32-7.36 2.05 4.08 5.86-5.83 1.15 2.28c.17.34.05.76-.27.95l-8.6 4.97c-.32.18-.72.18-1.04 0l-9.09-5.26z"
            fill="#DD2C00"
          />
        </svg>
      ),
...

    {
      ...
      icon: (
        ...
        >
          <path
            d="M12 6.5c-2.3 0-3.6 1.1-4 3.4.9-1.2 2-1.6 3.4-1.2.8.3 1.4.9 2 1.5 1.1 1.1 2.3 2.3 4.8 2.3 2.3 0 3.6-1.1 4-3.4-.9 1.2-2 1.6-3.4 1.2-.8-.3-1.4-.9-2-1.5-1.1-1.1-2.3-2.3-4.8-2.3zM6 12.5c-2.3 0-3.6 1.1-4 3.4.9-1.2 2-1.6 3.4-1.2.8.3 1.4.9 2 1.5 1.1 1.1 2.3 2.3 4.8 2.3 2.3 0 3.6-1.1 4-3.4-.9 1.2-2 1.6-3.4 1.2-.8-.3-1.4-.9-2-1.5-1.1-1.1-2.3-2.3-4.8-2.3z"
            fill="#06B6D4"
          />
        </svg>
      ),
      ...
      icon: (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M21 0C9.4 0 0 9.4 0 21s9.4 21 21 21 21-9.4 21-21S32.6 0 21 0zm7.1 27.6c-1.2 2.4-3.7 4-6.6 4-4.1 0-7.5-3.4-7.5-7.5s3.4-7.5 7.5-7.5c2.9 0 5.4 1.7 6.6 4h4.4c-1.5-4.7-5.9-8-11-8-6.4 0-11.5 5.1-11.5 11.5S15.1 35.5 21.5 35.5c5.1 0 9.5-3.3 11-8h-4.4z"
            fill="#FFB800"
          />
        </svg>
      ),
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-between relative overflow-hidden pt-20 md:pt-[100px]"
    >
      {/* ==========================================
          Background
      ========================================== */}
      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-8 lg:gap-16 items-center px-4 md:px-[5%] flex-grow content-center py-8">
          ...
          <div className="relative w-[320px] h-[320px] sm:w-[360px] sm:h-[360px] md:w-[400px] md:h-[400px] lg:w-[420px] lg:h-[420px]">
            ...
            {nodes.map((node, i) => (
              ...
              >
                ...
                <span className="text-[0.55rem] sm:text-[0.6rem] text-muted whitespace-nowrap font-medium">
                  {node.name}
                </span>
              </div>
            ))}
        ...
        <div className="flex-1 text-center md:text-left order-1 md:order-2 z-[2] pt-8 md:pt-0 animate-slideInRight relative min-h-[400px]">
          ...
          <div className="inline-flex items-center gap-2 bg-[rgba(0,212,255,0.08)] border border-[rgba(0,212,255,0.2)] px-4 py-1.5 rounded-full text-[0.8rem] text-cyan mb-6 mx-auto md:mx-0">
            <span className="w-2 h-2 bg-[#00ff88] rounded-full animate-blink"></span>
          ...
          <h1 className="font-syne text-[clamp(2.5rem,5vw,4.5rem)] font-extrabold leading-[1.05] mb-4">
            ...
            <span className="bg-gradient-to-br from-cyan via-cyan2 to-pink text-transparent bg-clip-text">
              Injamamul Hoq
            </span>
          </h1>
          ...
          <p
            className={`text-[1.2rem] sm:text-[1.25rem] font-semibold mb-8 tracking-[0.5px] h-[38px] flex items-center justify-center md:justify-start ${titles[currentIndex].color}`}
          >
            ✦ {currentText}
            ...
            {isCvLoading ? (
              ...
              <a
                /*
                  ...
                  Admin Panel থেকে upload করা
                  latest resume dynamically
                  /api/resume/view থেকে আসবে।
                */
            ...
            {[
              {
                ...
                url: "https://github.com/injamamulhoqtamim-bit",
              },

              {
                ...
                url: "https://www.linkedin.com/in/injamamul-hoq-tamim/",
              },

              {
                ...
                url: "https://www.facebook.com/injamamulo",
              },
            ].map((social, i) => (
              <a
                key={i}
