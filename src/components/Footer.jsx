...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-dark3 border-t border-border pt-12 pb-8 px-[5%] overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr] gap-8 mb-10">
        <div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto border-t border-border pt-6 flex justify-between items-center flex-wrap gap-3">
