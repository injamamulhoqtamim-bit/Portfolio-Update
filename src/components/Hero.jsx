      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-8 lg:gap-16 items-center px-4 md:px-[5%] flex-1">
        ...
        <div className="flex justify-center md:justify-start relative order-2 md:order-1">
          <div className="relative w-[320px] h-[320px] sm:w-[360px] sm:h-[360px] md:w-[400px] md:h-[400px] lg:w-[420px] lg:h-[420px]">
            ...
            <div className="absolute bg-gradient-to-r from-[#0a1428] via-[#112244] to-[#0a1428] border border-cyan-400/40 rounded-2xl px-6 py-3 text-[0.82rem] font-medium text-white whitespace-nowrap backdrop-blur-xl shadow-[0_10px_30px_rgba(0,212,255,0.2)] bottom-[15%] sm:bottom-[18%] left-1/3 -translate-x-1/2 animate-tag-float2 z-20">
        ...
        <div className="flex-1 text-center md:text-left order-1 md:order-2 z-[2] pt-8 md:pt-0">
